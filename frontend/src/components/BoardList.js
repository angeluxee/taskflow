...
export const BoardList = () => {
    const { boards, setSelectedBoard, editBoard, selectedBoard, addBoard } = useContext(BoardContext);
                        ...
                        {boardId === board._id.$oid ? (
                         <div className="relative"> 
                            ...
                            <svg 
                                ...
                                className="z-10 h-6 p-1 absolute top-2 right-2 transition-opacity hover:bg-gray-100 rounded-full cursor-pointer"
                                fill="none" 
                                viewBox="0 0 24 24" 
                                stroke="currentColor"
                                onClick={() => {
